<template>
    ...
    <span id="painel">
		...
		<pre>
			...
			Grupo2	Nome3
			Grupo2	Nome4</pre>
		<textarea id="nomesJogadores" style="width: 100%;height: 200px">
    A	jogador 1
    A	jogador 2
    A	jogador 3
    B	jogador 4
    ...
    B	jogador 6
		...
		<br>
      <div>
      <select v-model="grupos">
      <option disabled value="">Quantos Grupos?</option>
      <option>1</option>
      <option>2</option>
      <option>3</option>
      </select>
    ...
    <div>
    <button id="btnDistribua" @click="distribua()">Distribua {{grupos}} grupos!</button>
    </div>
...
export default {
  ...
  methods: {
    ...
    distribuirGrupo(grupo, jogadores) {
    ...
    distribua() {
			...
			let nomesJogadores = document.getElementById("nomesJogadores");
			let grupos = {};
			...
			// alert(grupos.A);
			for (grupo in grupos) {
				this.distribuirGrupo(grupo, grupos[grupo]);				
			}
		}
  },
}
